        ...
        <table id="newspaper-a" summary="2007 Major IT Companies' Profit">
          ...
          <tbody>
            ...
            while($array = mysqli_fetch_array($result)){
              ...
              <td><a href='fsubmission.php?board=$num&board_num=$array[board_num]'>$array[title]</a></td>
        ...
        <div style="text-align: center;">
           <?php
              if($numR!=0&&$page>$max_block && $pageNum<=$count*$max_block){
                  if($Ncount==1){
                      $next = $page-1;
                      echo"<a href='fileboard_list.php?board=$num&page=$next'>[이전]</a>";
                  }
                  for($next=(($count-1)*$max_block)+1; $next<=$pageNum; $next++){
                      if($page==$next){
                          ...
                          $go_page = $next;
                          echo"<a href='fileboard_list.php?board=$num&page=$go_page'>[$go_page]</a>";
                      }
                  }
              }
                  ...
                  if($Ncount==0){
                      $go_page = $page+1;
                      echo "<a href='fileboard_list.php?board=$num&page=$go_page'>[다음]</a>";
                  }
              }
                  ...
                  for($next=1; $next<=$max_block; $next++){
                      if($next==$page){
                          ...
                          echo "<a href='fileboard_list.php?board=$num&page=$next'>[$next]</a>";
                      }
                  }
